...
# dates to be updated: 1979-01 to 1 month ago. e.g. today is 2020-03-06, dats[-1].strftime('%Y-%m') is '2020-02'
dates = pd.date_range('2019-11', today.strftime('%Y-%m'), freq='MS').to_pydatetime()[:-1] 
