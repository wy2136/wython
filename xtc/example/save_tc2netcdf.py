...
if os.path.exists('params.py'):
    from params import expname, years, ens, model, track_tag, storm_type
else:
...
if not os.path.exists(ofile):
    ds = tc_tracks(expname=expname, years=years, ens=ens, model=model, track_tag=track_tag, storm_type=storm_type)
